...
export default function App() {
  ...
  if (userRole === 'public') {
    ...
    return (
      <div className="min-h-screen w-screen bg-slate-50 text-slate-800 font-sans flex flex-col relative overflow-y-auto">
        ...
        {/* Careers Header */}
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 py-4 px-8 shrink-0 flex items-center justify-between z-10 sticky top-0">
          <div className="flex items-center space-x-2">
            <div className="h-8 w-8 rounded-lg bg-blue-600 flex items-center justify-center font-bold text-white">IQ</div>
            <span className="font-extrabold text-lg tracking-wider bg-gradient-to-r from-blue-600 to-indigo-900 bg-clip-text text-transparent">HRIQ Careers</span>
          </div>
          <button 
            onClick={() => {
              setUserRole(null);
            ...
            className="text-xs border border-slate-250 hover:border-blue-600/50 hover:text-blue-600 text-slate-600 px-4 py-2 rounded-lg transition-all"
          >
        ...
        <div className="py-24 px-8 text-center relative overflow-hidden z-10">
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-100 px-4 py-1.5 rounded-full text-blue-600 text-xs font-semibold tracking-wider uppercase">
              We're Hiring
            </div>
            <h1 className="text-6xl font-black tracking-tight sm:text-7xl">
              Join <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-900">HRIQ</span>
            </h1>
        ...
        <div className="flex-1 max-w-6xl w-full mx-auto px-6 pb-24 z-10 space-y-20">
          {appliedApplicantResult ? (
            <div className="max-w-xl mx-auto bg-white border border-slate-200 rounded-3xl p-8 text-center space-y-6 shadow-2xl relative overflow-hidden">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 text-left space-y-3">
                <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                  <span className="text-xs font-semibold text-blue-600 uppercase tracking-widest flex items-center">
                    <Sparkles className="h-3.5 w-3.5 mr-1" /> HRIQ AI Matching Profile
                  </span>
                  <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded ${
                    appliedApplicantResult.status === 'Best Fit' ? 'bg-emerald-50 text-emerald-600 border border-emerald-200' :
                    appliedApplicantResult.status === 'Maybe' ? 'bg-amber-50 text-amber-600 border border-amber-200' :
                ...
                <div className="flex items-baseline space-x-2">
                  ...
                  <span className="text-2xl font-black text-slate-900">{appliedApplicantResult.score}%</span>
                </div>
              ...
              <button 
                ...
                className="w-full bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold py-3 rounded-lg text-xs transition-colors border border-slate-200"
              >
            ...
            <>
              ...
              <div className="space-y-6">
                <div className="text-center space-y-2">
                  <h2 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-indigo-900 bg-clip-text text-transparent">Open Job Opportunities</h2>
                  <p className="text-slate-500 text-sm">Select a role below to initiate quick AI matching evaluation.</p>
                </div>

                {publishedJobs.length === 0 ? (
                  <div className="bg-white border border-slate-200 rounded-3xl p-16 text-center text-slate-400 max-w-xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {publishedJobs.map(job => (
                      <div 
                        key={job.id} 
                        className="bg-white border border-slate-200 hover:border-blue-500/40 rounded-2xl p-6 flex flex-col justify-between space-y-6 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300 relative group"
                      >
                          ...
                          <div className="flex items-start justify-between">
                            <div>
                              ...
                              <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500 mt-2">
                                <span className="flex items-center bg-slate-50 border border-slate-150 px-2.5 py-1 rounded-md">
                                  <Folder className="h-3 w-3 mr-1 text-blue-500" /> {job.department}
                                </span>
                                <span className="flex items-center bg-slate-50 border border-slate-150 px-2.5 py-1 rounded-md">
                                  <MapPin className="h-3 w-3 mr-1 text-emerald-600" /> {job.location}
                                </span>
                                {job.salary && (
                                  <span className="flex items-center bg-slate-50 border border-slate-150 px-2.5 py-1 rounded-md">
                                    <DollarSign className="h-3 w-3 mr-0.5 text-amber-600" /> {job.salary}
                                  </span>
                                )}
                              </div>
                            </div>
                          ...
                          {job.desired_skills && (
                            <div className="flex flex-wrap gap-1.5 pt-2">
                              {job.desired_skills.split(',').map((skill: string) => (
                                <span key={skill} className="bg-slate-50 border border-slate-150 text-slate-600 text-[10px] px-2.5 py-1 rounded-md font-semibold">
                                  {skill.trim()}
                                </span>
                              ))}
                            </div>
                        ...
                        <button 
                          ...
                          className="w-full bg-blue-50 hover:bg-blue-600 text-blue-600 hover:text-white font-bold text-xs py-2.5 rounded-xl transition-all border border-blue-200 shadow-md group-hover:scale-[1.01]"
                        >
                          Apply For This Role
                        </button>
                      </div>
              ...
              <div className="border-t border-slate-200 pt-16 space-y-10">
                <div className="text-center space-y-2">
                  <h2 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-indigo-900 bg-clip-text text-transparent">Why HRIQ?</h2>
                  <p className="text-slate-500 text-sm">Our core principles and employee growth infrastructure.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm">
                    ...
                    <h4 className="text-md font-bold text-slate-900">AI-Powered Evaluations</h4>
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm">
                    ...
                    <h4 className="text-md font-bold text-slate-900">Remote-First Culture</h4>
                    <p className="text-xs text-slate-500 leading-relaxed">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm">
                    <div className="h-10 w-10 bg-amber-50 rounded-xl flex items-center justify-center text-amber-400">
                      <Award className="h-5 w-5" />
                    </div>
                    <h4 className="text-md font-bold text-slate-900">Hyper-Scale Growth</h4>
                    <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 space-y-5 relative shadow-2xl">
              ...
              <div>
                ...
                <p className="text-xs text-blue-600 font-medium mt-0.5">{selectedJobForApply.title}</p>
              </div>

              <form onSubmit={submitApplication} className="space-y-4 text-xs">
                <div>
                  <label className="block text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-1">Full Name</label>
                  <input 
                    type="text" 
                    required
                    value={applyForm.name}
                    onChange={e => setApplyForm({...applyForm, name: e.target.value})}
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-slate-900 outline-none focus:border-blue-500"
                    placeholder="John Doe"
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-1">Email</label>
                    <input 
                      type="email" 
                      required
                  ...
                  <div>
                    <label className="block text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-1">Phone</label>
                    <input 
                      type="text" 
                      required
                ...
                <div>
                  <label className="block text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-1">Upload Resume (PDF/DOCX)</label>
                  <input 
                    type="file" 
                    required
                    accept=".pdf,.docx"
